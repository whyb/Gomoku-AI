...
新版本（train_alphazero.py）采用 AlphaZero 风格的两阶段训练：先通过传统 AI 教师（Kali-Hac）知识蒸馏快速获得大师级审局能力，再用 MCTS 自博弈强化学习微调、超越教师。相比旧版本，训练效率与棋力上限更高，**推荐使用**。
...
- Player1 与 Kali-Hac Gomoku-AI 交替先手对战，Player1 作为训练目标。（旧版动态模型训练方式）
...
* [五子棋5×5 must5src](https://github.com/732857315/must5src)
